...
class Abstract3DUNet(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1, final_sigmoid=False, basic_module=DoubleConv, f_maps=64, layer_order='gcr',
                 num_groups=1, num_levels=4, is_segmentation=False, testing=False, **kwargs):
        ...
        self.final_pool = nn.MaxPool3d((44,1,1))
